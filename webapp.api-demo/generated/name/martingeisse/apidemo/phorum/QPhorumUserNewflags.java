...
public class QPhorumUserNewflags extends com.mysema.query.sql.RelationalPathBase<PhorumUserNewflags> {
    ...
    private static final long serialVersionUID = -1679704359;
     ...
     */
    public final com.mysema.query.sql.PrimaryKey<PhorumUserNewflags> pk_primary = createPrimaryKey(forumId, messageId, userId);
