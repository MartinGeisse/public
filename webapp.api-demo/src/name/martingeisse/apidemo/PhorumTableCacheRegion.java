...
import name.martingeisse.common.cache.querydsl.AbstractDirectRowRegion;
 ...
 */
public class PhorumTableCacheRegion<K extends Serializable, V> extends AbstractDirectRowRegion<K, V> {
