...
import name.martingeisse.forum.application.security.ForumSecurityProvider;
import name.martingeisse.forum.application.wicket.ForumWicketApplication;
...
public class Initializer {
	...
	public static void initializeBase() {
		...
		SecurityUtil.initialize(new ForumSecurityProvider());
	}
	...
	public static void initializeCassandraDatabase() {
		ForumCassandra.cluster = Cluster.builder().addContactPoint("localhost").build();
		ForumCassandra.session = ForumCassandra.cluster.connect("forum");
	}
	...
	public static void initializeHazelcast() {
		ForumHazelcast.instance = Hazelcast.newHazelcastInstance();
	}
	...
	public static void initializeWeb() {
		...
		wicketFilterHolder.setInitParameter("applicationClassName", ForumWicketApplication.class.getCanonicalName());
