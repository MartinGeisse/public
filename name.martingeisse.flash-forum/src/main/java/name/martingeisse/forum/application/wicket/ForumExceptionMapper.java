 ...
 */
public final class ForumExceptionMapper extends DefaultExceptionMapper {

	/**
	 * the logger
	 */
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(ForumExceptionMapper.class);
	...
	public IRequestHandler map(Exception e) {
		try {
			...
			logger.error("nested exception in ForumExceptionMapper", e2);
		}
