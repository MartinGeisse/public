...
import name.martingeisse.forum.application.specialpage.CassandraResetPage;
import name.martingeisse.forum.frontend.ConversationPage;
 ...
 */
public class ForumWicketApplication extends AbstractMyWicketApplication {
...
//		);
		...
		// --- mount pages ---
		// main pages
		mountPage("c/${id}", ConversationPage.class);
...
//		mountPage("bar/${id}", BarPage.class);
	...
	public Session newSession(final Request request, final Response response) {
		ForumWicketSession session = new ForumWicketSession(request);
		return session;
	}
	...
	public IProvider<IExceptionMapper> getExceptionMapperProvider() {
		return new IProvider<IExceptionMapper>() {
			...
			public IExceptionMapper get() {
				return new ForumExceptionMapper();
			}
		};
	}
