...
package name.martingeisse.forum.application.security;
 ...
 */
public class ForumSecurityProvider implements ISecurityProvider {

	/**
	 * the logger
	 */
	private static Logger logger = Logger.getLogger(ForumSecurityProvider.class);
