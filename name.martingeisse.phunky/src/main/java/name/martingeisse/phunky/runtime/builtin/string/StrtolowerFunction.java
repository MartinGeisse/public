...
/**
 * The built-in "strtolower" function.
 */
public final class StrtolowerFunction extends BuiltinFunctionWithValueParametersOnly {
	...
	public Object call(PhpRuntime runtime, CodeLocation location, Object[] arguments) {
		return getStringParameter(runtime, location, arguments, 0, null).toLowerCase();
	}
