 ...
 */
public final class PapyrosExceptionMapper extends DefaultExceptionMapper {

	/**
	 * the logger
	 */
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(PapyrosExceptionMapper.class);
	...
	public IRequestHandler map(Exception e) {
		try {
			...
			logger.error("nested exception in PapyrosExceptionMapper", e2);
		}
