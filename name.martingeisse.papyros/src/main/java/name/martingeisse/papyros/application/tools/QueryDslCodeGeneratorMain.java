...
public class QueryDslCodeGeneratorMain {
	...
	public static void main(String[] args) throws Exception {
		try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/papyros?zeroDateTimeBehavior=convertToNull&useTimezone=false&characterEncoding=utf8&characterSetResults=utf8", "root", "")) {
			MetaDataExporter exporter = new MetaDataExporter();
			exporter.setTargetFolder(new File("src/generated/java"));
			exporter.setPackageName("name.martingeisse.papyros.entity");
