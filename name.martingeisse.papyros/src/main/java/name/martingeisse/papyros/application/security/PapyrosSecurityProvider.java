...
package name.martingeisse.papyros.application.security;
 ...
 */
public class PapyrosSecurityProvider implements ISecurityProvider {

	/**
	 * the logger
	 */
	private static Logger logger = Logger.getLogger(PapyrosSecurityProvider.class);
