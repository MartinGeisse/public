 ...
 * 
 * The default implementation is {@link MultiChildParser}, which uses a list
 * of the child objects as the result.
 */
public abstract class AbstractMultiChildParser<E, R> implements ContentParser<R> {
	 ...
	 */
	private final ElementParser<E> childElementObjectBinding;
	 ...
	 */
	public AbstractMultiChildParser(boolean optional, String[] childObjectElementNameFilter, ElementParser<E> childElementObjectBinding) {
	 ...
	 */
	@Override
	public R parse(MyXmlStreamReader reader) throws XMLStreamException {
