 ...
 * a custom subclass of {@link AbstractPopulatorEntityDataTablePanel} or
 * {@link PopulatorBasedEntityListPanel} and mount it with an {@link EntityListPanelHandler}.
 */
public class PopulatorBasedEntityListHandler2 extends EntityListPanelHandler {
	 ...
	 */
	public PopulatorBasedEntityListHandler2(final EntityDescriptor entity, final PopulatorColumnDescriptor... columnDescriptors) {
	 ...
	 * @param columnDescriptors the column descriptors
	 */
	public PopulatorBasedEntityListHandler2(final String entityName, final PopulatorColumnDescriptor... columnDescriptors) {
	 ...
	 */
	public PopulatorBasedEntityListHandler2 setColumnDescriptors(final PopulatorColumnDescriptor[] columnDescriptors) {
		this.columnDescriptors = columnDescriptors;
		return this;
	}
