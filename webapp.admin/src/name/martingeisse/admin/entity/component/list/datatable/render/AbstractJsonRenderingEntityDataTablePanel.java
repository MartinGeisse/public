...
public abstract class AbstractJsonRenderingEntityDataTablePanel<CD extends RenderingColumnDescriptor> extends AbstractEntityDataTablePanel<CD> {
	 ...
	 * the entityInstances
	 */
	private transient List<IEntityInstance> entityInstances;
	 ...
	 */
	public List<IEntityInstance> getEntityInstances() {
	...
	protected void onInitialize() {
		...
		final ListView<IEntityInstance> entityInstancesListView = new ListView<IEntityInstance>("rows", new PropertyModel<List<IEntityInstance>>(this, "entityInstances")) {

			/* (non-Javadoc)
			 * @see org.apache.wicket.markup.html.list.ListView#populateItem(org.apache.wicket.markup.html.list.ListItem)
			 */
			@Override
			protected void populateItem(final ListItem<IEntityInstance> item) {
	 ...
	 */
	protected abstract void populateRowItem(ListItem<IEntityInstance> item);

	/**
	 * 
	 */
	@SuppressWarnings("unchecked")
	private void setEntityInstances(final Iterator<? extends IEntityInstance> iterator) {
	 ...
	 */
	@Override
	protected void assembleRows(final Iterator<? extends IEntityInstance> iterator, final JavascriptAssembler assembler) {
