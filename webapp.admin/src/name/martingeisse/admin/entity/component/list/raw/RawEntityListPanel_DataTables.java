 ...
 * Javascript.
 */
public class RawEntityListPanel_DataTables extends AbstractEntityDataTablePanel {
	...
	protected void onInitialize() {
		...
		// create components
		add(new Loop("headers", new PropertyModel<Integer>(RawEntityListPanel_DataTables.this, "columnCount")) {
			@Override
			protected void populateItem(LoopItem item) {
				item.add(new Label("name", getFieldNameForGloballyDefinedOrder(item.getIndex())));
			}
		});
		add(new Label("configuration", getCallbackUrl()));
	...
	/* (non-Javadoc)
	 * @see name.martingeisse.admin.entity.component.list.AbstractEntityDataTablePanel#isSearchSupported()
	 */
	@Override
