...
public abstract class AbstractEntityDataTablePanel<CD extends DataTableColumnDescriptor> extends Panel implements IEntityPredicateAcceptor, ISimpleCallbackListener {
	 ...
	 */
	protected abstract void assembleRowFields(IEntityInstance entityInstance, JavascriptAssembler assembler);
	...
	protected void assembleRows(final Iterator<? extends IEntityInstance> iterator, final JavascriptAssembler assembler) {
		...
		while (iterator.hasNext()) {
			final IEntityInstance entityInstance = iterator.next();
			assembler.prepareListElement();
			assembler.beginList();
	...
	public void onSimpleCallback() {
		...
		final Iterator<? extends IEntityInstance> iterator = dataProvider.iterator(offset, count);
