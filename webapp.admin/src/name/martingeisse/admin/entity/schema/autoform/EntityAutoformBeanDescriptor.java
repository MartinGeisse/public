 ...
 */
public class EntityAutoformBeanDescriptor extends AbstractAutoformBeanDescriptor<EntityInstance> {
	 ...
	 */
	public EntityAutoformBeanDescriptor(final EntityInstance entityInstance, final List<IAutoformPropertyDescriptor> propertyDescriptors) {
