...
import name.martingeisse.admon.security.authentication.IUserIdentity;
import name.martingeisse.admon.security.authentication.IUserProperties;
import name.martingeisse.admon.security.authentication.UserProperties;
import name.martingeisse.admon.security.authorization.CorePermissionRequest;
import name.martingeisse.admon.security.authorization.IAdminAuthorizationStrategy;
import name.martingeisse.admon.security.authorization.IPermissionRequest;
import name.martingeisse.admon.security.authorization.IPermissions;
import name.martingeisse.admon.security.authorization.PermissionDeniedException;
import name.martingeisse.admon.security.authorization.UnauthorizedPermissions;
import name.martingeisse.admon.security.credentials.ICredentials;
...
public class SecurityUtil {
	 ...
	 * - check the user's login permission ({@link name.martingeisse.admon.security.authorization.CorePermissionRequest.Type#LOGIN})
