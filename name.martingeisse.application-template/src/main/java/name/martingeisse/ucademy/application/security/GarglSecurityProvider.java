...
package name.martingeisse.ucademy.application.security;
 ...
 */
public class GarglSecurityProvider implements ISecurityProvider {

	/**
	 * the logger
	 */
	private static Logger logger = Logger.getLogger(GarglSecurityProvider.class);
