...
import name.martingeisse.ucademy.application.security.GarglSecurityProvider;
import name.martingeisse.ucademy.application.wicket.GarglWicketApplication;
...
public class Initializer {
	...
	public static void initializeCassandraDatabase() {
		...
		GarglCassandra.session = GarglCassandra.cluster.connect("ucademy");
	}
