 ...
 */
public class HtmlEditor implements IEditor, Serializable {
	...
	public Component createComponent(final String id) {
		return new HtmlEditorPanel(id, new PropertyModel<String>(this, "contents"), workspaceResourcePath);
	}
	...
	public void updateMarkers(final List<FetchMarkerResult> markers) {
		// TODO: not yet needed -- the HTML editor panel adds a future for the compilation result and markers itself
	}
