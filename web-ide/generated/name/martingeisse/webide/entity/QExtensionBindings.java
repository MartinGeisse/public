...
public class QExtensionBindings extends com.mysema.query.sql.RelationalPathBase<ExtensionBindings> {
    ...
    /**
     * Metamodel property for property 'extension_network_id'
     */
    public final NumberPath<Long> extensionNetworkId = createNumber("extension_network_id", Long.class);
     ...
     */
    public final com.mysema.query.sql.ForeignKey<ExtensionNetworks> fk_extensionBindingsIbfk1 = createForeignKey(extensionNetworkId, "id");
