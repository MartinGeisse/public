...
import name.martingeisse.hackathon.application.security.ApplicationSecurityProvider;
import name.martingeisse.hackathon.application.wicket.ApplicationWicketApplication;
...
public class Initializer {
	...
	public static void initializeBase() {
		...
		SecurityUtil.initialize(new ApplicationSecurityProvider());
	}
	...
	public static void initializeSqlDatabase() {
		...
		ApplicationSqldb.database = database;
	}
	...
	public static void initializeCassandraDatabase() {
		ApplicationCassandra.cluster = Cluster.builder().addContactPoint("localhost").build();
		ApplicationCassandra.session = ApplicationCassandra.cluster.connect("hackathon_2014_08_02");
	}
	...
	public static void initializeWeb() {
		...
		wicketFilterHolder.setInitParameter("applicationClassName", ApplicationWicketApplication.class.getCanonicalName());
