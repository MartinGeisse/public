 ...
 */
public final class ApplicationeExceptionMapper extends DefaultExceptionMapper {

	/**
	 * the logger
	 */
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(ApplicationeExceptionMapper.class);
	...
	public IRequestHandler map(Exception e) {
		try {
			...
			logger.error("nested exception in ApplicationeExceptionMapper", e2);
		}
