...
package name.martingeisse.hackathon.application.security;
 ...
 */
public class ApplicationSecurityProvider implements ISecurityProvider {

	/**
	 * the logger
	 */
	private static Logger logger = Logger.getLogger(ApplicationSecurityProvider.class);
