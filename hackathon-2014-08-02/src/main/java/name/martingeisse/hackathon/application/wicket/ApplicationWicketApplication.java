...
import name.martingeisse.hackathon.application.page.AbstractApplicationPage;
import name.martingeisse.hackathon.application.specialpage.CassandraResetPage;
import name.martingeisse.hackathon.frontend.HelloWorldPage;
 ...
 */
public class ApplicationWicketApplication extends AbstractMyWicketApplication {
...
//		mountPage("bar/${id}", BarPage.class);
	...
	public Session newSession(final Request request, final Response response) {
		ApplicationWicketSession session = new ApplicationWicketSession(request);
		return session;
	}
	...
	public IProvider<IExceptionMapper> getExceptionMapperProvider() {
		return new IProvider<IExceptionMapper>() {
			...
			public IExceptionMapper get() {
				return new ApplicationeExceptionMapper();
			}
		};
	}
