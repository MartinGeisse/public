 ...
 * entity to fetch.
 */
public class QueryConditions implements Predicate, Cloneable, Operation<Boolean> {
	 ...
	 */
	public QueryConditions(final Path<?> entityPath) {
	 ...
	 */
	public QueryConditions(final Path<?> entityPath, final Operator<Boolean> buildOperator) {
		if (entityPath == null) {
	 ...
	 */
	@Override
	protected final QueryConditions clone() throws CloneNotSupportedException {
		return (QueryConditions)super.clone();
	}
	...
	public boolean equals(final Object obj) {
		if (obj == this) {
			...
			final QueryConditions other = (QueryConditions)obj;
