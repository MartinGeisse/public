 ...
 */
public class SlaveServicesWicketApplication extends AbstractMyWicketApplication {
...
//		);
	...
	public Session newSession(final Request request, final Response response) {
		SlaveServicesWicketSession session = new SlaveServicesWicketSession(request);
		return session;
	}
	...
	public IProvider<IExceptionMapper> getExceptionMapperProvider() {
		return new IProvider<IExceptionMapper>() {
			...
			public IExceptionMapper get() {
				return new SlaveServicesExceptionMapper();
			}
		};
	}
