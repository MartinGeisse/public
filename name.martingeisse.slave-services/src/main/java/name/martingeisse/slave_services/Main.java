...
package name.martingeisse.slave_services;

import name.martingeisse.slave_services.application.Configuration;
import name.martingeisse.slave_services.application.Initializer;
